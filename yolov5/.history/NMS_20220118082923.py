...
def convert_yolov5_preds(valid_files_dir, labels_dir, out_file):
    valid_files = glob.glob(valid_files_dir + '*.jpg'or'*.png' )
...
if __name__ == '__main__':
    # Location of images
    valid_files_dir = 'images/validate/images/'
    # Location of yolo v5 predictions
    labels_dir = 'images/validate/images/'
    # CSF-file to store results
    out_file = './runs_train_exp6_results.csv'
