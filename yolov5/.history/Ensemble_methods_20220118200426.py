...
data_frame_concat = pd.concat(all_data_frame, axis=1, ignore_index=True, sort=True)
data_frame_concat.to_csv("./wine.npy", index=False, encoding="utf-8")     # 将重组后的数据集重新写入一个文件
