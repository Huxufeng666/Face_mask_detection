            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    if save_txt:  # Write to file
                        ...
                        with open('text_results_1 _copy.txt', 'a') as f:
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / 'Maskdata/test/images/-12.jpg', help='file/dir/URL/glob, 0 for webcam')
