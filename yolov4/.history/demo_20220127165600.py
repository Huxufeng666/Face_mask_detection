...
def detect_cv2(cfgfile, weightfile, imgfile):
    ...
    img,boxes = plot_boxes_cv2(img, boxes[0], savename='predictions.jpg', class_names=class_names)
...
def detect_skimage(cfgfile, weightfile, imgfile):
    ...
    img ,boxes   = plot_boxes_cv2(img, boxes, savename='predictions.jpg', class_names=class_names)
...
if __name__ == '__main__':
    ...
    #   bboxes_v4  =  detect_cv2(args.cfgfile, args.weightfile, args.imgfile)
       yolov4_bbox = detect_cv2(args.cfgfile, args.weightfile, args.imgfile)
