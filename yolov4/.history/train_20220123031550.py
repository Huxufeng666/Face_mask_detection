...
def get_args(**kwargs):
    ...
    parser.add_argument('-g', '--gpu', metavar='G', type=str, default='0',
                        help='GPU', dest='gpu')
    parser.add_argument('-dir', '--data-dir', type=str, default='./MaskPascalVOC/images/',
    ...
    parser.add_argument('-train_label_path', dest='train_label', type=str, default='./MaskPascalVOC/train.txt', help="train label path")
    parser.add_argument(
