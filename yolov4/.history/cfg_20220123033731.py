...
# Cfg.train_label = os.path.join(_BASE_DIR, 'MaskPascalVOC/', 'train.txt')
# Cfg.val_label = os.path.join(_BASE_DIR, 'MaskPascalVOC/' ,'val.txt')
Cfg.train_label = ('MaskPascalVOC_train.txt')
Cfg.val_label = ('MaskPascalVOC_val.txt')
